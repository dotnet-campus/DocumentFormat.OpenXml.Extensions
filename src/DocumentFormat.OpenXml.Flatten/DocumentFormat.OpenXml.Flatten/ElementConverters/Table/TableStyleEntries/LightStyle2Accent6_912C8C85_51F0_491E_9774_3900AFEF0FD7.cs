...
internal static class LightStyle2Accent6_912C8C85_51F0_491E_9774_3900AFEF0FD7
{
    public static TableStyleEntry GenerateTableStyleEntry()
    {
        TableStyleEntry tableStyleEntry1 = new TableStyleEntry() { StyleId = "{912C8C85-51F0-491E-9774-3900AFEF0FD7}", StyleName = "浅色样式 2 - 强调 6" };
