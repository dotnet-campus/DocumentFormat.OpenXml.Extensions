...
namespace DocumentFormat.OpenXml.Flatten.ElementConverters.TableStyleEntries
{
    ...
    internal static class MediumStyle1Accent2_9DCAF9ED_07DC_4A11_8D7F_57B35C25682E
    {
        // Creates an TableStyleEntry instance and adds its children.
        public static TableStyleEntry GenerateTableStyleEntry()
        {
            TableStyleEntry tableStyleEntry1 = new TableStyleEntry() { StyleId = "{9DCAF9ED-07DC-4A11-8D7F-57B35C25682E}", StyleName = "中度样式 1 - 强调 2" };
            ...
            SchemeColor schemeColor3 = new SchemeColor() { Val = SchemeColorValues.Accent2 };
