...
namespace DocumentFormat.OpenXml.Flatten.ElementConverters.TableStyleEntries
{
    ...
    internal static class DarkStyle1_E8034E78_7F5D_4C2E_B375_FC64B27BC917
    {
        // Creates an TableStyleEntry instance and adds its children.
        public static TableStyleEntry GenerateTableStyleEntry()
        {
            TableStyleEntry tableStyleEntry1 = new TableStyleEntry() { StyleId = "{E8034E78-7F5D-4C2E-B375-FC64B27BC917}", StyleName = "深色样式 1" };
            ...
            Tint tint5 = new Tint() { Val = 60000 };

            schemeColor8.Append(tint5);
            ...
            Tint tint6 = new Tint() { Val = 60000 };

            schemeColor10.Append(tint6);
