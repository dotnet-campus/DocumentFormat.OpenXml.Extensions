...
namespace DocumentFormat.OpenXml.Flatten.ElementConverters.TableStyleEntries
{
    ...
    internal static class MediumStyle3Accent3_EB344D84_9AFB_497E_A393_DC336BA19D2E
    {
        // Creates an TableStyleEntry instance and adds its children.
        public static TableStyleEntry GenerateTableStyleEntry()
        {
            TableStyleEntry tableStyleEntry1 = new TableStyleEntry() { StyleId = "{EB344D84-9AFB-497E-A393-DC336BA19D2E}", StyleName = "中度样式 3 - 强调 3" };
