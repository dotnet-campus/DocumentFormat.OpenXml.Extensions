...
namespace DocumentFormat.OpenXml.Flatten.ElementConverters.TableStyleEntries
{
    ...
    internal static class MediumStyle3Accent2_85BE263C_DBD7_4A20_BB59_AAB30ACAA65A
    {
        // Creates an TableStyleEntry instance and adds its children.
        public static TableStyleEntry GenerateTableStyleEntry()
        {
            TableStyleEntry tableStyleEntry1 = new TableStyleEntry() { StyleId = "{85BE263C-DBD7-4A20-BB59-AAB30ACAA65A}", StyleName = "中度样式 3 - 强调 2" };
