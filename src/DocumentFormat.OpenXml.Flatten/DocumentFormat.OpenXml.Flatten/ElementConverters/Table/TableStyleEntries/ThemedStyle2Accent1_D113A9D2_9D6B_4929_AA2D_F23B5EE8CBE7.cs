...
internal static class ThemedStyle2Accent1_D113A9D2_9D6B_4929_AA2D_F23B5EE8CBE7
{
    public static TableStyleEntry GenerateTableStyleEntry()
    {
        TableStyleEntry tableStyleEntry1 = new TableStyleEntry() { StyleId = "{D113A9D2-9D6B-4929-AA2D-F23B5EE8CBE7}", StyleName = "主题样式 2 - 强调 1" };

        TableBackground tableBackground1 = new TableBackground();

        FillReference fillReference1 = new FillReference() { Index = (UInt32Value) 3U };
        SchemeColor schemeColor1 = new SchemeColor() { Val = SchemeColorValues.Accent1 };
