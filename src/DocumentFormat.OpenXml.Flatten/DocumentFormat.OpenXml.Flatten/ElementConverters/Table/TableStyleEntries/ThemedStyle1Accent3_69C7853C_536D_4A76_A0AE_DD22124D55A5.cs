...
internal static class ThemedStyle1Accent3_69C7853C_536D_4A76_A0AE_DD22124D55A5
{
    public static TableStyleEntry GenerateTableStyleEntry()
    {
        TableStyleEntry tableStyleEntry1 = new TableStyleEntry() { StyleId = "{69C7853C-536D-4A76-A0AE-DD22124D55A5}", StyleName = "主题样式 1 - 强调 3" };

        TableBackground tableBackground1 = new TableBackground();

        FillReference fillReference1 = new FillReference() { Index = (UInt32Value) 2U };
        SchemeColor schemeColor1 = new SchemeColor() { Val = SchemeColorValues.Accent3 };
        ...
        SchemeColor schemeColor7 = new SchemeColor() { Val = SchemeColorValues.Accent3 };
        ...
        SchemeColor schemeColor11 = new SchemeColor() { Val = SchemeColorValues.Accent3 };
        ...
        SchemeColor schemeColor12 = new SchemeColor() { Val = SchemeColorValues.Accent3 };
        ...
        SchemeColor schemeColor14 = new SchemeColor() { Val = SchemeColorValues.Accent3 };
        ...
        SchemeColor schemeColor15 = new SchemeColor() { Val = SchemeColorValues.Accent3 };
        ...
        SchemeColor schemeColor16 = new SchemeColor() { Val = SchemeColorValues.Accent3 };
        ...
        SchemeColor schemeColor17 = new SchemeColor() { Val = SchemeColorValues.Accent3 };
        ...
        SchemeColor schemeColor18 = new SchemeColor() { Val = SchemeColorValues.Accent3 };
        ...
        SchemeColor schemeColor19 = new SchemeColor() { Val = SchemeColorValues.Accent3 };
        ...
        SchemeColor schemeColor20 = new SchemeColor() { Val = SchemeColorValues.Accent3 };
        ...
        SchemeColor schemeColor21 = new SchemeColor() { Val = SchemeColorValues.Accent3 };
        ...
        SchemeColor schemeColor22 = new SchemeColor() { Val = SchemeColorValues.Accent3 };
        ...
        SchemeColor schemeColor23 = new SchemeColor() { Val = SchemeColorValues.Accent3 };
        ...
        SchemeColor schemeColor24 = new SchemeColor() { Val = SchemeColorValues.Accent3 };
        ...
        SchemeColor schemeColor25 = new SchemeColor() { Val = SchemeColorValues.Accent3 };
        ...
        SchemeColor schemeColor26 = new SchemeColor() { Val = SchemeColorValues.Accent3 };
        ...
        SchemeColor schemeColor27 = new SchemeColor() { Val = SchemeColorValues.Accent3 };
        ...
        SchemeColor schemeColor29 = new SchemeColor() { Val = SchemeColorValues.Accent3 };
        ...
        SchemeColor schemeColor30 = new SchemeColor() { Val = SchemeColorValues.Accent3 };
        ...
        SchemeColor schemeColor31 = new SchemeColor() { Val = SchemeColorValues.Accent3 };
        ...
        SchemeColor schemeColor33 = new SchemeColor() { Val = SchemeColorValues.Accent3 };
