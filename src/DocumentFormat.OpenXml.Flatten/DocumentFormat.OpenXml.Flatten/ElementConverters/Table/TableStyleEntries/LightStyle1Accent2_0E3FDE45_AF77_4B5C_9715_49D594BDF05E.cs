...
internal static class LightStyle1Accent2_0E3FDE45_AF77_4B5C_9715_49D594BDF05E
{
    public static TableStyleEntry GenerateTableStyleEntry()
    {
        TableStyleEntry tableStyleEntry1 = new TableStyleEntry() { StyleId = "{0E3FDE45-AF77-4B5C-9715-49D594BDF05E}", StyleName = "浅色样式 1 - 强调 2" };
