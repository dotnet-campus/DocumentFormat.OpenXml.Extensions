...
namespace DocumentFormat.OpenXml.Flatten.ElementConverters.TableStyleEntries
{
    ...
    internal static class MediumStyle4Accent2_8A107856_5554_42FB_B03E_39F5DBC370BA
    {
        // Creates an TableStyleEntry instance and adds its children.
        public static TableStyleEntry GenerateTableStyleEntry()
        {
            TableStyleEntry tableStyleEntry1 = new TableStyleEntry() { StyleId = "{8A107856-5554-42FB-B03E-39F5DBC370BA}", StyleName = "中度样式 4 - 强调 2" };
