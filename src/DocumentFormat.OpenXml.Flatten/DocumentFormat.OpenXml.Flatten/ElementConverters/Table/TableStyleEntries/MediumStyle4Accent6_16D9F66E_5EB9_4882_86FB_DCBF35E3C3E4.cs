...
namespace DocumentFormat.OpenXml.Flatten.ElementConverters.TableStyleEntries
{
    ...
    internal static class MediumStyle4Accent6_16D9F66E_5EB9_4882_86FB_DCBF35E3C3E4
    {
        // Creates an TableStyleEntry instance and adds its children.
        public static TableStyleEntry GenerateTableStyleEntry()
        {
            TableStyleEntry tableStyleEntry1 = new TableStyleEntry() { StyleId = "{16D9F66E-5EB9-4882-86FB-DCBF35E3C3E4}", StyleName = "中度样式 4 - 强调 6" };
