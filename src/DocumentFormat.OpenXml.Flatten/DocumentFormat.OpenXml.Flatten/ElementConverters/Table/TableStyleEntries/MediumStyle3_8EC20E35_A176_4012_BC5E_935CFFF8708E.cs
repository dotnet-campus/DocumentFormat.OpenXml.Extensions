...
namespace DocumentFormat.OpenXml.Flatten.ElementConverters.TableStyleEntries
{
    ...
    internal static class MediumStyle3_8EC20E35_A176_4012_BC5E_935CFFF8708E
    {
        // Creates an TableStyleEntry instance and adds its children.
        public static TableStyleEntry GenerateTableStyleEntry()
        {
            TableStyleEntry tableStyleEntry1 = new TableStyleEntry() { StyleId = "{8EC20E35-A176-4012-BC5E-935CFFF8708E}", StyleName = "中度样式 3" };
            ...
            fontReference2.Append(rgbColorModelPercentage1);
            ...
            fontReference3.Append(rgbColorModelPercentage2);
            ...
            SchemeColor schemeColor10 = new SchemeColor() { Val = SchemeColorValues.Dark1 };
            ...
            fontReference4.Append(rgbColorModelPercentage3);
            ...
            fontReference5.Append(rgbColorModelPercentage4);
            ...
            fontReference6.Append(rgbColorModelPercentage5);
            ...
            SchemeColor schemeColor17 = new SchemeColor() { Val = SchemeColorValues.Dark1 };
