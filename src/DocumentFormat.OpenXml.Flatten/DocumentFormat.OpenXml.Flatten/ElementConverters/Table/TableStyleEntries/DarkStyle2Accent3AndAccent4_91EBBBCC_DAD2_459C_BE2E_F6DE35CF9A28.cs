...
namespace DocumentFormat.OpenXml.Flatten.ElementConverters.TableStyleEntries
{
    ...
    internal static class DarkStyle2Accent3AndAccent4_91EBBBCC_DAD2_459C_BE2E_F6DE35CF9A28
    {
        // Creates an TableStyleEntry instance and adds its children.
        public static TableStyleEntry GenerateTableStyleEntry()
        {
            TableStyleEntry tableStyleEntry1 = new TableStyleEntry() { StyleId = "{91EBBBCC-DAD2-459C-BE2E-F6DE35CF9A28}", StyleName = "深色样式 2 - 强调 3和强调 4" };
