...
namespace DocumentFormat.OpenXml.Flatten.ElementConverters.TableStyleEntries
{
    ...
    internal static class DarkStyle1Accent4_E929F9F4_4A8F_4326_A1B4_22849713DDAB
    {
        // Creates an TableStyleEntry instance and adds its children.
        public static TableStyleEntry GenerateTableStyleEntry()
        {
            TableStyleEntry tableStyleEntry1 = new TableStyleEntry() { StyleId = "{E929F9F4-4A8F-4326-A1B4-22849713DDAB}", StyleName = "深色样式 1 - 强调 4" };
