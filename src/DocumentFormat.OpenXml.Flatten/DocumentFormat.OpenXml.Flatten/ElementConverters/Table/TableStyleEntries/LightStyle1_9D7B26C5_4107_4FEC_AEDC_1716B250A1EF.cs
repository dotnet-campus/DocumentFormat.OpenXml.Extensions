...
internal static class LightStyle1_9D7B26C5_4107_4FEC_AEDC_1716B250A1EF
{
    public static TableStyleEntry GenerateTableStyleEntry()
    {
        TableStyleEntry tableStyleEntry1 = new TableStyleEntry() { StyleId = "{9D7B26C5-4107-4FEC-AEDC-1716B250A1EF}", StyleName = "浅色样式 1" };
