...
namespace DocumentFormat.OpenXml.Flatten.ElementConverters.TableStyleEntries
{
    ...
    internal static class MediumStyle2Accent1_5C22544A_7EE6_4342_B048_85BDC9FD1C3A
    {
        public static TableStyleEntry GenerateTableStyleEntry()
        {
            TableStyleEntry tableStyleEntry1 = new TableStyleEntry() { StyleId = "{5C22544A-7EE6-4342-B048-85BDC9FD1C3A}", StyleName = "中度样式 2 - 强调 1" };
            ...
            SchemeColor schemeColor14 = new SchemeColor() { Val = SchemeColorValues.Accent1 };
            ...
            SchemeColor schemeColor17 = new SchemeColor() { Val = SchemeColorValues.Accent1 };
            ...
            SchemeColor schemeColor20 = new SchemeColor() { Val = SchemeColorValues.Accent1 };
