...
internal static class ThemedStyle2Accent6_638B1855_1B75_4FBE_930C_398BA8C253C6
{
    public static TableStyleEntry GenerateTableStyleEntry()
    {
        TableStyleEntry tableStyleEntry1 = new TableStyleEntry() { StyleId = "{638B1855-1B75-4FBE-930C-398BA8C253C6}", StyleName = "主题样式 2 - 强调 6" };
