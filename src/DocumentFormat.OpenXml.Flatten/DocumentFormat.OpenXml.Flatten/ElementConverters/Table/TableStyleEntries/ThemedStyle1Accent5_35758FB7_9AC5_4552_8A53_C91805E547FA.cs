...
internal static class ThemedStyle1Accent5_35758FB7_9AC5_4552_8A53_C91805E547FA
{
    public static TableStyleEntry GenerateTableStyleEntry()
    {
        TableStyleEntry tableStyleEntry1 = new TableStyleEntry() { StyleId = "{35758FB7-9AC5-4552-8A53-C91805E547FA}", StyleName = "主题样式 1 - 强调 5" };
        ...
        SchemeColor schemeColor13 = new SchemeColor() { Val = SchemeColorValues.Accent5 };
        ...
        SchemeColor schemeColor15 = new SchemeColor() { Val = SchemeColorValues.Accent5 };
        ...
        SchemeColor schemeColor16 = new SchemeColor() { Val = SchemeColorValues.Accent5 };
        ...
        SchemeColor schemeColor18 = new SchemeColor() { Val = SchemeColorValues.Accent5 };
        ...
        SchemeColor schemeColor19 = new SchemeColor() { Val = SchemeColorValues.Accent5 };
        ...
        SchemeColor schemeColor20 = new SchemeColor() { Val = SchemeColorValues.Accent5 };
        ...
        SchemeColor schemeColor21 = new SchemeColor() { Val = SchemeColorValues.Accent5 };
        ...
        SchemeColor schemeColor22 = new SchemeColor() { Val = SchemeColorValues.Accent5 };
        ...
        SchemeColor schemeColor23 = new SchemeColor() { Val = SchemeColorValues.Accent5 };
        ...
        SchemeColor schemeColor24 = new SchemeColor() { Val = SchemeColorValues.Accent5 };
        ...
        SchemeColor schemeColor25 = new SchemeColor() { Val = SchemeColorValues.Accent5 };
        ...
        SchemeColor schemeColor26 = new SchemeColor() { Val = SchemeColorValues.Accent5 };
        ...
        SchemeColor schemeColor27 = new SchemeColor() { Val = SchemeColorValues.Accent5 };
        ...
        SchemeColor schemeColor29 = new SchemeColor() { Val = SchemeColorValues.Accent5 };
        ...
        SchemeColor schemeColor30 = new SchemeColor() { Val = SchemeColorValues.Accent5 };
        ...
        SchemeColor schemeColor31 = new SchemeColor() { Val = SchemeColorValues.Accent5 };
        ...
        SchemeColor schemeColor33 = new SchemeColor() { Val = SchemeColorValues.Accent5 };
