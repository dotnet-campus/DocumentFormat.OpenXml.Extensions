...
namespace DocumentFormat.OpenXml.Flatten.ElementConverters.TableStyleEntries
{
    ...
    internal static class DarkStyle1Accent1_125E5076_3810_47DD_B79F_674D7AD40C01
    {
        // Creates an TableStyleEntry instance and adds its children.
        public static TableStyleEntry GenerateTableStyleEntry()
        {
            TableStyleEntry tableStyleEntry1 = new TableStyleEntry() { StyleId = "{125E5076-3810-47DD-B79F-674D7AD40C01}", StyleName = "深色样式 1 - 强调 1" };
