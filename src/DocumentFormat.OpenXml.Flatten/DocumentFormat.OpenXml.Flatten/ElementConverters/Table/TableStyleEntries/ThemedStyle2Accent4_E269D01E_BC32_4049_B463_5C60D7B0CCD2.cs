...
internal static class ThemedStyle2Accent4_E269D01E_BC32_4049_B463_5C60D7B0CCD2
{
    public static TableStyleEntry GenerateTableStyleEntry()
    {
        TableStyleEntry tableStyleEntry1 = new TableStyleEntry() { StyleId = "{E269D01E-BC32-4049-B463-5C60D7B0CCD2}", StyleName = "主题样式 2 - 强调 4" };
