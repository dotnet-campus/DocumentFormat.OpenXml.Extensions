...
namespace DocumentFormat.OpenXml.Flatten.ElementConverters.TableStyleEntries
{
    ...
    internal static class MediumStyle4Accent3_0505E3EF_67EA_436B_97B2_0124C06EBD24
    {
        // Creates an TableStyleEntry instance and adds its children.
        public static TableStyleEntry GenerateTableStyleEntry()
        {
            TableStyleEntry tableStyleEntry1 = new TableStyleEntry() { StyleId = "{0505E3EF-67EA-436B-97B2-0124C06EBD24}", StyleName = "中度样式 4 - 强调 3" };
