...
namespace DocumentFormat.OpenXml.Flatten.ElementConverters.TableStyleEntries
{
    ...
    internal static class MediumStyle2Accent3_F5AB1C69_6EDB_4FF4_983F_18BD219EF322
    {
        // Creates an TableStyleEntry instance and adds its children.
        public static TableStyleEntry GenerateTableStyleEntry()
        {
            TableStyleEntry tableStyleEntry1 = new TableStyleEntry() { StyleId = "{F5AB1C69-6EDB-4FF4-983F-18BD219EF322}", StyleName = "中度样式 2 - 强调 3" };
