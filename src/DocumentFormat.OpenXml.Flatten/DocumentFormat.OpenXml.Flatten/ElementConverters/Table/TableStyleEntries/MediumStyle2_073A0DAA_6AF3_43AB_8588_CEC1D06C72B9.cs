...
namespace DocumentFormat.OpenXml.Flatten.ElementConverters.TableStyleEntries
{
    ...
    internal static class MediumStyle2_073A0DAA_6AF3_43AB_8588_CEC1D06C72B9
    {
        // Creates an TableStyleEntry instance and adds its children.
        public static TableStyleEntry GenerateTableStyleEntry()
        {
            TableStyleEntry tableStyleEntry1 = new TableStyleEntry() { StyleId = "{073A0DAA-6AF3-43AB-8588-CEC1D06C72B9}", StyleName = "中度样式 2" };
            ...
            SchemeColor schemeColor9 = new SchemeColor() { Val = SchemeColorValues.Dark1 };
            ...
            SchemeColor schemeColor20 = new SchemeColor() { Val = SchemeColorValues.Dark1 };
