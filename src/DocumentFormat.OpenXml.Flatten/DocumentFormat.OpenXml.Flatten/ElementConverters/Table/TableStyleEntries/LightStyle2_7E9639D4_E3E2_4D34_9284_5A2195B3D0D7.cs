...
internal static class LightStyle2_7E9639D4_E3E2_4D34_9284_5A2195B3D0D7
{
    public static TableStyleEntry GenerateTableStyleEntry()
    {
        TableStyleEntry tableStyleEntry1 = new TableStyleEntry() { StyleId = "{7E9639D4-E3E2-4D34-9284-5A2195B3D0D7}", StyleName = "浅色样式 2" };
        ...
        SchemeColor schemeColor8 = new SchemeColor() { Val = SchemeColorValues.Text1 };
        ...
        SchemeColor schemeColor9 = new SchemeColor() { Val = SchemeColorValues.Text1 };
        ...
        SchemeColor schemeColor10 = new SchemeColor() { Val = SchemeColorValues.Text1 };
        ...
        SchemeColor schemeColor11 = new SchemeColor() { Val = SchemeColorValues.Text1 };
        ...
        SchemeColor schemeColor12 = new SchemeColor() { Val = SchemeColorValues.Text1 };
        ...
        SchemeColor schemeColor14 = new SchemeColor() { Val = SchemeColorValues.Text1 };
