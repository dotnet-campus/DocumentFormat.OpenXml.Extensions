...
internal static class ThemedStyle1Accent6_08FB837D_C827_4EFA_A057_4D05807E0F7C
{
    public static TableStyleEntry GenerateTableStyleEntry()
    {
        TableStyleEntry tableStyleEntry1 = new TableStyleEntry() { StyleId = "{08FB837D-C827-4EFA-A057-4D05807E0F7C}", StyleName = "主题样式 1 - 强调 6" };

        TableBackground tableBackground1 = new TableBackground();

        FillReference fillReference1 = new FillReference() { Index = (UInt32Value) 2U };
        SchemeColor schemeColor1 = new SchemeColor() { Val = SchemeColorValues.Accent6 };
        ...
        SchemeColor schemeColor5 = new SchemeColor() { Val = SchemeColorValues.Accent6 };
        ...
        SchemeColor schemeColor7 = new SchemeColor() { Val = SchemeColorValues.Accent6 };
        ...
        SchemeColor schemeColor9 = new SchemeColor() { Val = SchemeColorValues.Accent6 };
        ...
        SchemeColor schemeColor11 = new SchemeColor() { Val = SchemeColorValues.Accent6 };
        ...
        SchemeColor schemeColor12 = new SchemeColor() { Val = SchemeColorValues.Accent6 };
        ...
        SchemeColor schemeColor13 = new SchemeColor() { Val = SchemeColorValues.Accent6 };
        ...
        SchemeColor schemeColor14 = new SchemeColor() { Val = SchemeColorValues.Accent6 };
        ...
        SchemeColor schemeColor15 = new SchemeColor() { Val = SchemeColorValues.Accent6 };
        ...
        SchemeColor schemeColor16 = new SchemeColor() { Val = SchemeColorValues.Accent6 };
        ...
        SchemeColor schemeColor17 = new SchemeColor() { Val = SchemeColorValues.Accent6 };
        ...
        SchemeColor schemeColor18 = new SchemeColor() { Val = SchemeColorValues.Accent6 };
        ...
        SchemeColor schemeColor19 = new SchemeColor() { Val = SchemeColorValues.Accent6 };
        ...
        SchemeColor schemeColor20 = new SchemeColor() { Val = SchemeColorValues.Accent6 };
        ...
        SchemeColor schemeColor21 = new SchemeColor() { Val = SchemeColorValues.Accent6 };
        ...
        SchemeColor schemeColor22 = new SchemeColor() { Val = SchemeColorValues.Accent6 };
        ...
        SchemeColor schemeColor23 = new SchemeColor() { Val = SchemeColorValues.Accent6 };
        ...
        SchemeColor schemeColor24 = new SchemeColor() { Val = SchemeColorValues.Accent6 };
        ...
        SchemeColor schemeColor25 = new SchemeColor() { Val = SchemeColorValues.Accent6 };
        ...
        SchemeColor schemeColor26 = new SchemeColor() { Val = SchemeColorValues.Accent6 };
        ...
        SchemeColor schemeColor27 = new SchemeColor() { Val = SchemeColorValues.Accent6 };
        ...
        SchemeColor schemeColor29 = new SchemeColor() { Val = SchemeColorValues.Accent6 };
        ...
        SchemeColor schemeColor30 = new SchemeColor() { Val = SchemeColorValues.Accent6 };
        ...
        SchemeColor schemeColor31 = new SchemeColor() { Val = SchemeColorValues.Accent6 };
        ...
        SchemeColor schemeColor33 = new SchemeColor() { Val = SchemeColorValues.Accent6 };
