...
internal static class ThemedStyle1Accent4_775DCB02_9BB8_47FD_8907_85C794F793BA
{
    public static TableStyleEntry GenerateTableStyleEntry()
    {
        TableStyleEntry tableStyleEntry1 = new TableStyleEntry() { StyleId = "{775DCB02-9BB8-47FD-8907-85C794F793BA}", StyleName = "主题样式 1 - 强调 4" };

        TableBackground tableBackground1 = new TableBackground();

        FillReference fillReference1 = new FillReference() { Index = (UInt32Value) 2U };
        SchemeColor schemeColor1 = new SchemeColor() { Val = SchemeColorValues.Accent4 };

        fillReference1.Append(schemeColor1);

        EffectReference effectReference1 = new EffectReference() { Index = (UInt32Value) 1U };
        SchemeColor schemeColor2 = new SchemeColor() { Val = SchemeColorValues.Accent4 };
        ...
        SchemeColor schemeColor4 = new SchemeColor() { Val = SchemeColorValues.Accent4 };
        ...
        SchemeColor schemeColor5 = new SchemeColor() { Val = SchemeColorValues.Accent4 };
        ...
        SchemeColor schemeColor6 = new SchemeColor() { Val = SchemeColorValues.Accent4 };
        ...
        SchemeColor schemeColor7 = new SchemeColor() { Val = SchemeColorValues.Accent4 };
        ...
        SchemeColor schemeColor8 = new SchemeColor() { Val = SchemeColorValues.Accent4 };
        ...
        SchemeColor schemeColor9 = new SchemeColor() { Val = SchemeColorValues.Accent4 };
        ...
        SchemeColor schemeColor10 = new SchemeColor() { Val = SchemeColorValues.Accent4 };
        ...
        SchemeColor schemeColor11 = new SchemeColor() { Val = SchemeColorValues.Accent4 };
        ...
        SchemeColor schemeColor12 = new SchemeColor() { Val = SchemeColorValues.Accent4 };
        ...
        SchemeColor schemeColor13 = new SchemeColor() { Val = SchemeColorValues.Accent4 };
        ...
        SchemeColor schemeColor14 = new SchemeColor() { Val = SchemeColorValues.Accent4 };
        ...
        SchemeColor schemeColor15 = new SchemeColor() { Val = SchemeColorValues.Accent4 };
        ...
        SchemeColor schemeColor16 = new SchemeColor() { Val = SchemeColorValues.Accent4 };
        ...
        SchemeColor schemeColor17 = new SchemeColor() { Val = SchemeColorValues.Accent4 };
        ...
        SchemeColor schemeColor18 = new SchemeColor() { Val = SchemeColorValues.Accent4 };
        ...
        SchemeColor schemeColor19 = new SchemeColor() { Val = SchemeColorValues.Accent4 };
        ...
        SchemeColor schemeColor20 = new SchemeColor() { Val = SchemeColorValues.Accent4 };
        ...
        SchemeColor schemeColor21 = new SchemeColor() { Val = SchemeColorValues.Accent4 };
        ...
        SchemeColor schemeColor22 = new SchemeColor() { Val = SchemeColorValues.Accent4 };
        ...
        SchemeColor schemeColor23 = new SchemeColor() { Val = SchemeColorValues.Accent4 };
        ...
        SchemeColor schemeColor24 = new SchemeColor() { Val = SchemeColorValues.Accent4 };
        ...
        SchemeColor schemeColor25 = new SchemeColor() { Val = SchemeColorValues.Accent4 };
        ...
        SchemeColor schemeColor26 = new SchemeColor() { Val = SchemeColorValues.Accent4 };
        ...
        SchemeColor schemeColor27 = new SchemeColor() { Val = SchemeColorValues.Accent4 };
        ...
        SchemeColor schemeColor29 = new SchemeColor() { Val = SchemeColorValues.Accent4 };
        ...
        SchemeColor schemeColor30 = new SchemeColor() { Val = SchemeColorValues.Accent4 };
        ...
        SchemeColor schemeColor31 = new SchemeColor() { Val = SchemeColorValues.Accent4 };
        ...
        SchemeColor schemeColor33 = new SchemeColor() { Val = SchemeColorValues.Accent4 };
