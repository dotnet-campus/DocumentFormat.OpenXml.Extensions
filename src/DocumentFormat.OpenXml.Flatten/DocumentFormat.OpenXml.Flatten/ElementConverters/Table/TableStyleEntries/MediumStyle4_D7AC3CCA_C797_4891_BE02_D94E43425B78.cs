...
namespace DocumentFormat.OpenXml.Flatten.ElementConverters.TableStyleEntries
{
    ...
    internal static class MediumStyle4_D7AC3CCA_C797_4891_BE02_D94E43425B78
    {
        // Creates an TableStyleEntry instance and adds its children.
        public static TableStyleEntry GenerateTableStyleEntry()
        {
            TableStyleEntry tableStyleEntry1 = new TableStyleEntry() { StyleId = "{D7AC3CCA-C797-4891-BE02-D94E43425B78}", StyleName = "中度样式 4" };
            ...
            SchemeColor schemeColor7 = new SchemeColor() { Val = SchemeColorValues.Dark1 };
