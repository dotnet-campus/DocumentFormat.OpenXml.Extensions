...
namespace DocumentFormat.OpenXml.Flatten.ElementConverters.TableStyleEntries
{
    ...
    internal static class MediumStyle1Accent1_B301B821_A1FF_4177_AEE7_76D212191A09
    {
        // Creates an TableStyleEntry instance and adds its children.
        public static TableStyleEntry GenerateTableStyleEntry()
        {
            TableStyleEntry tableStyleEntry1 = new TableStyleEntry() { StyleId = "{B301B821-A1FF-4177-AEE7-76D212191A09}", StyleName = "中度样式 1 - 强调 1" };
