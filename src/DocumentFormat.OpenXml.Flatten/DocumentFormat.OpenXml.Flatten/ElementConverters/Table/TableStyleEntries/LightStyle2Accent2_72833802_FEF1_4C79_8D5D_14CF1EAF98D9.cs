...
internal static class LightStyle2Accent2_72833802_FEF1_4C79_8D5D_14CF1EAF98D9
{
    public static TableStyleEntry GenerateTableStyleEntry()
    {
        TableStyleEntry tableStyleEntry1 = new TableStyleEntry() { StyleId = "{72833802-FEF1-4C79-8D5D-14CF1EAF98D9}", StyleName = "浅色样式 2 - 强调 2" };
