...
namespace DocumentFormat.OpenXml.Flatten.ElementConverters.TableStyleEntries
{
    ...
    internal static class MediumStyle4Accent4_C4B1156A_380E_4F78_BDF5_A606A8083BF9
    {
        // Creates an TableStyleEntry instance and adds its children.
        public static TableStyleEntry GenerateTableStyleEntry()
        {
            TableStyleEntry tableStyleEntry1 = new TableStyleEntry() { StyleId = "{C4B1156A-380E-4F78-BDF5-A606A8083BF9}", StyleName = "中度样式 4 - 强调 4" };
            ...
            SchemeColor schemeColor3 = new SchemeColor() { Val = SchemeColorValues.Accent4 };
