...
internal static class LightStyle1Accent5_5FD0F851_EC5A_4D38_B0AD_8093EC10F338
{
    public static TableStyleEntry GenerateTableStyleEntry()
    {
        TableStyleEntry tableStyleEntry1 = new TableStyleEntry() { StyleId = "{5FD0F851-EC5A-4D38-B0AD-8093EC10F338}", StyleName = "浅色样式 1 - 强调 5" };
