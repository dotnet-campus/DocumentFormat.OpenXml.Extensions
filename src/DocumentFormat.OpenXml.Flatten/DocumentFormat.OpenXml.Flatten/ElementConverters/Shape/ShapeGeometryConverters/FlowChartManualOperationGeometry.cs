...
namespace DocumentFormat.OpenXml.Flatten.ElementConverters.ShapeGeometryConverters
{
    ...
    /// 流程图: 手动操作
    /// </summary>
    public class FlowChartManualOperationGeometry : ShapeGeometryBase
    {
        ...
        public override ShapePath[]? GetMultiShapePaths(EmuSize emuSize, AdjustValueList? adjusts = null)
        {
            ...
            //<gd name="x3" fmla="*/ w 4 5" xmlns="http://schemas.openxmlformats.org/drawingml/2006/main" />
            var x3 = w * 4 / 5;
            //<gd name="x4" fmla="*/ w 9 10" xmlns="http://schemas.openxmlformats.org/drawingml/2006/main" />
            var x4 = w * 9 / 10;
            ...
            //  <pt x="1" y="5" />
            //</lnTo>
            currentPoint = LineToToString(stringPath, 1, 5);
            ...
            InitializeShapeTextRectangle(wd5, t, x3, b);
