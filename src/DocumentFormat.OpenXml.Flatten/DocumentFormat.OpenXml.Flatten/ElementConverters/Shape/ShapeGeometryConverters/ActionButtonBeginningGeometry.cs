...
namespace DocumentFormat.OpenXml.Flatten.ElementConverters.ShapeGeometryConverters
{
    ...
    /// 动作按钮: 转到开头
    /// </summary>
    public class ActionButtonBeginningGeometry : ShapeGeometryBase
    {
        /// <inheritdoc />
        ...
        public override ShapePath[]? GetMultiShapePaths(EmuSize emuSize, AdjustValueList? adjusts = null)
        {
            ...
            var g14 = g13 * 1 / 8;
            //<gd name="g15" fmla="*/ g13 1 4" xmlns="http://schemas.openxmlformats.org/drawingml/2006/main" />
            var g15 = g13 * 1 / 4;
            ...
            //  <pt x="g17" y="vc" />
            //</moveTo>
            currentPoint = new EmuPoint(g17, vc);
            stringPath.Append($"M {EmuToPixelString(currentPoint.X)},{EmuToPixelString(currentPoint.Y)} ");
            //<lnTo xmlns="http://schemas.openxmlformats.org/drawingml/2006/main">
            //  <pt x="g12" y="g9" />
            //</lnTo>
            ...
            //  <pt x="g16" y="g9" />
            //</moveTo>
            currentPoint = new EmuPoint(g16, g9);
            stringPath.Append($"M {EmuToPixelString(currentPoint.X)},{EmuToPixelString(currentPoint.Y)} ");
            //<lnTo xmlns="http://schemas.openxmlformats.org/drawingml/2006/main">
            //  <pt x="g11" y="g9" />
            //</lnTo>
            ...
            //  <pt x="g16" y="g10" />
            //</lnTo>
            currentPoint = LineToToString(stringPath, g16, g10);
            //<close xmlns="http://schemas.openxmlformats.org/drawingml/2006/main" />
            stringPath.Append("z ");
