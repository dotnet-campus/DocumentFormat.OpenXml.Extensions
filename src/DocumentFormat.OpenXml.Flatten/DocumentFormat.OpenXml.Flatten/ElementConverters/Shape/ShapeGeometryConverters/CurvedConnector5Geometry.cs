...
namespace DocumentFormat.OpenXml.Flatten.ElementConverters.ShapeGeometryConverters
{
    ...
    /// 连接符：曲线5
    /// </summary>
    public class CurvedConnector5Geometry : ShapeGeometryBase
    {
        /// <inheritdoc />
        ...
        public override ShapePath[]? GetMultiShapePaths(ElementEmuSize emuSize, AdjustValueList? adjusts = null)
        {
            ...
            //      <pt x="x3" y="y1" />
            //    </cubicBezTo>
            currentPoint = CubicBezToString(stringPath, x2, t, x3, y2, x3, y1);
            //    <cubicBezTo>
            //      <pt x="x3" y="y3" />
            //      <pt x="x4" y="y4" />
            //      <pt x="x1" y="y4" />
            //    </cubicBezTo>
            currentPoint = CubicBezToString(stringPath, x3, y3, x4, y4, x1, y4);
            //    <cubicBezTo>
            //      <pt x="x5" y="y4" />
            //      <pt x="x6" y="y6" />
            //      <pt x="x6" y="y5" />
            //    </cubicBezTo>
            currentPoint = CubicBezToString(stringPath, x5, y4, x6, y6, x6, y5);
            //    <cubicBezTo>
            //      <pt x="x6" y="y7" />
            //      <pt x="x7" y="b" />
            //      <pt x="r" y="b" />
            //    </cubicBezTo>
            currentPoint = CubicBezToString(stringPath, x6, y7, x7, b, r, b);
            //  </path>
