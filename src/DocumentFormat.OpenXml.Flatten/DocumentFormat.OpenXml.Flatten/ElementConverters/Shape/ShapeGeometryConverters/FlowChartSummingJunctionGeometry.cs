...
namespace DocumentFormat.OpenXml.Flatten.ElementConverters.ShapeGeometryConverters
{
    ...
    /// 流程图: 汇总连接
    /// </summary>
    public class FlowChartSummingJunctionGeometry : ShapeGeometryBase
    {
        ...
        public override ShapePath[]? GetMultiShapePaths(EmuSize emuSize, AdjustValueList? adjusts = null)
        {
            ...
            //  <pt x="il" y="it" />
            //</moveTo>
            currentPoint = new EmuPoint(il, it);
            stringPath.Clear();
            stringPath.Append($"M {EmuToPixelString(currentPoint.X)},{EmuToPixelString(currentPoint.Y)} ");
            //<lnTo xmlns="http://schemas.openxmlformats.org/drawingml/2006/main">
            //  <pt x="ir" y="ib" />
            //</lnTo>
            currentPoint = LineToToString(stringPath, ir, ib);
            //<moveTo xmlns="http://schemas.openxmlformats.org/drawingml/2006/main">
            //  <pt x="ir" y="it" />
            //</moveTo>
            currentPoint = new EmuPoint(ir, it);
            stringPath.Append($"M {EmuToPixelString(currentPoint.X)},{EmuToPixelString(currentPoint.Y)} ");
            //<lnTo xmlns="http://schemas.openxmlformats.org/drawingml/2006/main">
            //  <pt x="il" y="ib" />
            //</lnTo>
            currentPoint = LineToToString(stringPath, il, ib);
