...
namespace DocumentFormat.OpenXml.Flatten.ElementConverters.ShapeGeometryConverters
{
    ...
    /// 标注: 弯曲线形(无边框)
    /// </summary>
    public class Callout2Geometry : ShapeGeometryBase
    {
        /// <inheritdoc />
        ...
        public override ShapePath[]? GetMultiShapePaths(ElementEmuSize emuSize, AdjustValueList? adjusts = null)
        {
            ...
            var adj5 = customAdj5 ?? 112500d;
            var customAdj6 = adjusts?.GetAdjustValue("adj6");
            var adj6 = customAdj6 ?? -46667d;
            ...
            //  </path>
            stringPath.Append("z ");
            pathLst[0] = new ShapePath(stringPath.ToString(), isStroke: false);
            ...
            //  </path>
            pathLst[1] = new ShapePath(stringPath.ToString(), PathFillModeValues.None);
