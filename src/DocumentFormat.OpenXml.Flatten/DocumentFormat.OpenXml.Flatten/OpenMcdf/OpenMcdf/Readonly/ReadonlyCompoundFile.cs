...
#pragma warning disable 414 // 有几个字段是有赋值但是实际上没有用到的，符合预期，用于辅助调试
...
namespace OpenMcdf
{
    ...
    public class ReadonlyCompoundFile : IDisposable
    {
        ...
        internal bool ValidationExceptionEnabled { get; } = true;
        ...
        /// <summary>
        /// Copy the <paramref name="sourceCompoundFileStream"/> content to <paramref name="destinationStream"/>
        /// </summary>
        /// <param name="sourceCompoundFileStream"></param>
            ...
            IByteArrayPool byteArrayPool = null)
        {
            ...
            var sectorChain = GetNormalSectorChainLowMemory(de.StartSetc);
            if (sectorChain == null)
            {
                return;
            }
        ...
        /// <summary>
        /// Get the directory entry name from id
        /// </summary>
        /// <param name="id"></param>
        /// <returns></returns>
